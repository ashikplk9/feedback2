<%@ Control Language="C#" AutoEventWireup="true" CodeFile="add_course.ascx.cs" Inherits="admin_add_course" %>
<style type="text/css">
    input[type="text"],
	input[type="password"],
	input[type="email"],
...
<table class="style1">
    ...
    <tr>
        <td class="style2">
            Department Name</td>
        <td><md-input-container flex-gt-sm="">
            <asp:TextBox ID="TextBox2" runat="server" Width="216px"></asp:TextBox></md-input-container>
        </td>
    </tr>
    <tr>
        <td class="style2">
