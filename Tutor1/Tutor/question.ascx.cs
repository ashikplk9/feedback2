...
public partial class Tutor_question : System.Web.UI.UserControl
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
      ...
      cmd.CommandText = "select * from tbl_qstn where qno=" +i+ "";
              ...
              if (opt == "Excellent")
              {
                  cmd.CommandText = "update tbl_feedback set opt1=opt1+1 where sub_code=@cd and qno=@q";
              ...
              {
                  cmd.CommandText = "update tbl_feedback set opt2=opt2+1 where sub_code=@cd and qno=@q";
                  cmd.Parameters.AddWithValue("@cd", Label8.Text);
                  cmd.Parameters.AddWithValue("@q", a);
              ...
              {
                  cmd.CommandText = "update tbl_feedback set opt3=opt3+1 where sub_code=@cd and qno=@q";
                  cmd.Parameters.AddWithValue("@cd", Label8.Text);
                  cmd.Parameters.AddWithValue("@q", a);
              ...
              {
                  cmd.CommandText = "update tbl_feedback set opt4=opt4+1 where sub_code=@cd and qno=@q";
                  cmd.Parameters.AddWithValue("@cd", Label8.Text);
                  cmd.Parameters.AddWithValue("@q", a);
              ...
              {
                  cmd.CommandText = "update tbl_feedback set opt5=opt5+1 where sub_code=@cd and qno=@q";
                  cmd.Parameters.AddWithValue("@cd", Label8.Text);
                  cmd.Parameters.AddWithValue("@q", a);
              ...
              {
                  cmd.CommandText = "update tbl_feedback set opt6=opt6+1 where sub_code=@cd and qno=@q";
                  cmd.Parameters.AddWithValue("@cd", Label8.Text);
                  cmd.Parameters.AddWithValue("@q",a);
